    ...
    return (
      <div className = "backdrop">
        ...
        <div className="container">
          <Image src="assets/infinty.png" className="center img-fluid about-profile-pic" alt="Infinity logo"/>
        </div>
        <h1 className="bighead">Isolated Above, Connected Below</h1>
        <Grid>
          <Col sm={6}>
              <div className="">
                <div className="s-cards" id="divisions">
          ...
          <Col sm={6}>
            <div className="">
              <div className="s-cards" id="technology">
