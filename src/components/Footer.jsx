    ...
    return (
      ...
      <Container>
        <Row  text-center class="">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 footer-content">
            <h5>Quick links</h5>
        ...
        <Row>
          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5 footer-content">
        ...
        <Row>
          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white footer-content">
